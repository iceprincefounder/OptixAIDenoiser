...
OIIO::ImageBuf* input_beauty = NULL;
OIIO::ImageBuf* input_albedo = NULL;
OIIO::ImageBuf* input_normal = NULL;
...
int main(int argc, char *argv[])
{
    ...
    for (int i=1; i<argc; i++)
    {
        ...
        else if (arg == "-b")
        {
            ...
            blend = strtof((blend_string).c_str(),0);
            // blend = std::strtof(blend_string);
        ...
        else if (arg == "-hdr")
        {
            ...
            hdr = (int)strtof((hdr_string).c_str(),0);
